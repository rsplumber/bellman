...
internal sealed class SendSmsEventHandler : ICapSubscribe
{
    ...
    {
        _notificationManagement = notificationManagement.FirstOrDefault(p=>p.ProviderName =="persiafava") ?? throw new ArgumentException("Register provider");
    }

    [CapSubscribe("notification_send_persiafava")]
